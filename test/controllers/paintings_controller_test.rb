...
class PaintingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create painting" do
    assert_difference('Painting.count') do
      post paintings_url, params: { painting: { gallery_id: @painting.gallery_id, image: @painting.image, title: @painting.title } }
    end
  ...
  test "should update painting" do
    patch painting_url(@painting), params: { painting: { gallery_id: @painting.gallery_id, image: @painting.image, title: @painting.title } }
